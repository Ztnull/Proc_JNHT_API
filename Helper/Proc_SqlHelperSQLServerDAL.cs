...
namespace DBHelp
{
    ...
    /// SqlServer数据访问帮助类
    /// </summary>
    public sealed class Proc_SqlHelperSQLServerDAL
    {
        public static readonly string Proc_SqlConn = DBHelp.DBHelper.Connection;
        #region 私有构造函数和方法

        private Proc_SqlHelperSQLServerDAL() { }
        ...
        /// 按照Where条件返回整形ID
        /// </summary>
        /// <param name="strSelect">整形ID所在的字段</param>
        /// <param name="strFrom">from</param>
        /// <param name="strWhere">where</param>
        /// <returns></returns>
        public static int GetReturnLong(string strSelect, string strFrom, string strWhere)
        {
            DataSet ds = new DataSet();

            int lngReturnID = 0;
            string sql = "";
            sql = "SELECT " + strSelect.Trim() + " FROM " + strFrom + " WHERE " + strWhere.Trim();
            ds = ExecuteDataset(Proc_SqlConn, CommandType.Text, sql);
            try
            {
                ...
                if (ds.Tables[0].Rows.Count != 0)
                {
                    ...
                    {
                        lngReturnID = Convert.ToInt32(ds.Tables[0].Rows[0][0]);
                    }
                    ds.Clear();
                }
                else
        ...
        public static DataTable GetDataTable(string str)
        {
            ...
            ds = ExecuteDataset(Proc_SqlConn, CommandType.Text, str);
            try
            {
        ...
        /// <param name="strWhere">where</param>
        /// <returns></returns>
        public static string GetReturnString(string strSelect, string strFrom, string strWhere)
        {
            DataSet ds = new DataSet();

            string lngReturnString = "";
            string sql = "";
            sql = "SELECT " + strSelect.Trim() + " FROM " + strFrom + " WHERE " + strWhere.Trim();
            ds = ExecuteDataset(Proc_SqlConn, CommandType.Text, sql);
            try
            {
                ...
                if (ds.Tables[0].Rows.Count != 0)
                {
                    ...
                    {
                        lngReturnString = Convert.ToString(ds.Tables[0].Rows[0][0]);
                    }
                    ds.Clear();
                }
                else
        ...
        public static int ExecuteNonQueryTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Proc_SqlHelperSQLServerDAL.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return Proc_SqlHelperSQLServerDAL.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return Proc_SqlHelperSQLServerDAL.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static DataSet ExecuteDatasetTypedParams(string connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return Proc_SqlHelperSQLServerDAL.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return Proc_SqlHelperSQLServerDAL.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return Proc_SqlHelperSQLServerDAL.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static SqlDataReader ExecuteReaderTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Proc_SqlHelperSQLServerDAL.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
            }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return Proc_SqlHelperSQLServerDAL.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return Proc_SqlHelperSQLServerDAL.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static object ExecuteScalarTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return Proc_SqlHelperSQLServerDAL.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Proc_SqlHelperSQLServerDAL.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                // 分配参数值
                AssignParameterValues(commandParameters, dataRow);
                return Proc_SqlHelperSQLServerDAL.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Proc_SqlHelperSQLServerDAL.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return Proc_SqlHelperSQLServerDAL.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return Proc_SqlHelperSQLServerDAL.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        public static SqlDataReader GetReader(string str)
        {

            SqlDataReader reader = ExecuteReader(Proc_SqlConn, CommandType.Text, str);
            return reader;
            reader.Close();
            reader.Dispose();
        }
